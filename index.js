...
const url = "https://p2p.binance.com/en/trade/BankofKhartoum/USDT?fiat=SDG";
...
app.get('/', async (req, res) => {
    try {
        ...
        const adjustedRate = numberRTS * 1.05; // Adjust the rate by multiplying by 0.95
...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div id="data-container">
            <h1 class="title">Calculate The Amount (Buy)</h1>
            <div class="rate">
